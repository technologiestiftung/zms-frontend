...
# ZMS Bürgeramt Prototyp Supabase Frontend

This is the frontend for the ZMS Prototyp Bürgeramt (Citizens' Registration Office) project.

The repo for our backend is here: https://github.com/technologiestiftung/zms-supabase
...
2. Install dependencies (`npm ci --force` because there are some dependencies mismatches that work none the less)
3. Copy the file `.env.example` to `.env` and add the variables values accordingly

## Development
Start the development server (`npm run dev`)

## Tests
There are no tests for this prototype yet.
